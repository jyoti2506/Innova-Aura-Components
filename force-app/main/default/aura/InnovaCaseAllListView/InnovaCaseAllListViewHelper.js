({
    ...
    fetchData: function(component) {
        // Show spinner when fetching data starts
        //this.setAttribute(component, "isLoading", true);
// component.set("v.isLoading", true);
        ...
        this.fetchCases(component)
            ...
            .then(() => this.removeSpinner(component)) // Hide spinner when data is fetched
            .catch(error => {
                console.error('Error in Promise Chain:', error);
                //this.removeSpinner(component); // Ensure spinner is removed even in case of error
            });
    },
 ...
 setButtonVisibility: function(component) {
    ...
    // Disable 'First' button if we're at the first page
    ...
    // Disable 'Last' button if we're at the last page
    this.setAttribute(component, "disableLastButton", pageNumber >= totalPages);

    // If not on the first page, enable the 'First' and 'Previous' buttons
    if (pageNumber > 1) {
        this.setAttribute(component, "disableFirstButton", false);
        this.setAttribute(component, "disablePreviousButton", false);
    }
},
